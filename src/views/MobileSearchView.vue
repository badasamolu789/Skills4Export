...
<template>
  <section class="mx-auto max-w-3xl space-y-5">
    <div class="flex items-center gap-3">
      ...
      <h1 class="text-[1.35rem] font-semibold leading-tight text-[var(--text-primary)]">Search</h1>
    </div>

    <label
      class="flex items-center gap-3 rounded-[1rem] border border-[color:var(--border-soft)] bg-[var(--surface-primary)] px-4 py-3 shadow-[var(--shadow-soft)]"
    >
